...
library LibAssetData {
  ...
  function decodeAssetProxyId(
    bytes memory assetData
  ) public pure returns (bytes4 assetProxyId) {
  ...
  function decodeERC20AssetData(
    bytes memory assetData
  ) public pure returns (bytes4 assetProxyId, address tokenAddress) {
    assetProxyId = assetData.readBytes4(0);
  ...
  function decodeERC721AssetData(
    bytes memory assetData
  )
    public
    pure
    returns (bytes4 assetProxyId, address tokenAddress, uint256 tokenId)
  {
    assetProxyId = assetData.readBytes4(0);
  ...
  function decodeERC1155AssetData(
    bytes memory assetData
  )
    public
    pure
    ...
    )
  {
    ...
    return (assetProxyId, tokenAddress, tokenIds, tokenValues, callbackData);
  }
